...
exports.otpValidator = exports.updateValidator = exports.signupValidator = exports.loginValidator = void 0;
...
exports.signupValidator = zod_1.z.object({
    ...
    referralCode: zod_1.z.string().length(6, { message: "Refferal code must be 6 characters long." }).optional()
});
